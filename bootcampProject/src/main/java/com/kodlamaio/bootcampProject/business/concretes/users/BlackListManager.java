...
public class BlackListManager implements BlackListService {
	...
	this.checkIfApplicantExists(createBlackListRequest.getApplicantId());
	...
	public DataResult<UpdateBlackListResponse> update(UpdateBlackListRequest updateBlackListRequest) {
		this.checkIfApplicantExists(updateBlackListRequest.getApplicantId());
		this.checkIfBlackListExistById(updateBlackListRequest.getId());
